...
var Module = typeof FFInit !== 'undefined' ? FFInit : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ffwasm_decode_open')) {
        Object.defineProperty(Module['ready'], '_ffwasm_decode_open', { configurable: true, get: function() { abort('You are getting _ffwasm_decode_open on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ffwasm_decode_open', { configurable: true, set: function() { abort('You are setting _ffwasm_decode_open on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ffwasm_decode_frame')) {
        Object.defineProperty(Module['ready'], '_ffwasm_decode_frame', { configurable: true, get: function() { abort('You are getting _ffwasm_decode_frame on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ffwasm_decode_frame', { configurable: true, set: function() { abort('You are setting _ffwasm_decode_frame on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ffwasm_decode_free')) {
        Object.defineProperty(Module['ready'], '_ffwasm_decode_free', { configurable: true, get: function() { abort('You are getting _ffwasm_decode_free on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ffwasm_decode_free', { configurable: true, set: function() { abort('You are setting _ffwasm_decode_free on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ffwasm_hold_seek')) {
        Object.defineProperty(Module['ready'], '_ffwasm_hold_seek', { configurable: true, get: function() { abort('You are getting _ffwasm_hold_seek on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ffwasm_hold_seek', { configurable: true, set: function() { abort('You are setting _ffwasm_hold_seek on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ffwasm_seek_frame')) {
        Object.defineProperty(Module['ready'], '_ffwasm_seek_frame', { configurable: true, get: function() { abort('You are getting _ffwasm_seek_frame on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ffwasm_seek_frame', { configurable: true, set: function() { abort('You are setting _ffwasm_seek_frame on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _ffwasm_decode_open = Module["_ffwasm_decode_open"] = createExportWrapper("ffwasm_decode_open");

/** @type {function(...*):?} */
var _ffwasm_decode_frame = Module["_ffwasm_decode_frame"] = createExportWrapper("ffwasm_decode_frame");

/** @type {function(...*):?} */
var _ffwasm_hold_seek = Module["_ffwasm_hold_seek"] = createExportWrapper("ffwasm_hold_seek");

/** @type {function(...*):?} */
var _ffwasm_seek_frame = Module["_ffwasm_seek_frame"] = createExportWrapper("ffwasm_seek_frame");

/** @type {function(...*):?} */
var _ffwasm_decode_free = Module["_ffwasm_decode_free"] = createExportWrapper("ffwasm_decode_free");
...
var _ff_h264_cabac_tables = Module['_ff_h264_cabac_tables'] = 1032924;
